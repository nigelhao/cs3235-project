...
if [ $? != 0 ]; then
    ...
    tmux send-keys -t nakafour "./target/debug/bin_client ${CLIENT_SECCOMP_PATH} ./tests/nakamoto_config1 ${NAKAMOTO_SECCOMP_PATH} ./tests/_secrets/Wallet.A.json ${WALLET_SECCOMP_PATH}" C-m
