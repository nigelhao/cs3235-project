...
#[cfg(test)]
mod tests {
    use crate::block::{BlockNode, BlockTree, MerkleTree, Transaction};
        ...
        let mut tx = Transaction {
            sender:
                "MDgCMQCqrJ1yIJ7cDQIdTuS+4CkKn/tQPN7bZFbbGCBhvjQxs71f6Vu+sD9eh8JGpfiZSckCAwEAAQ=="
                    .to_string(),
            receiver:
                "MDgCMQDOpK8YWmcg8ffNF/O7xlBDq/DBdoUnc4yyWrV0y/X3LF+dddjaGksXzGl3tHskpgkCAwEAAQ=="
                    .to_string(),
        ...
        let tx2 = Transaction {
            sender:
                "MDgCMQCqrJ1yIJ7cDQIdTuS+4CkKn/tQPN7bZFbbGCBhvjQxs71f6Vu+sD9eh8JGpfiZSckCAwEAAQ=="
                    .to_string(),
            receiver:
                "MDgCMQDeoEeA8OtGME/SRwp+ASKVOnjlEUHYvQfo0FLp3+fwVi/SztDdJskjzCRasGk06UUCAwEAAQ=="
                    .to_string(),
    ...
    fn block_test_basic() {
        ...
        block_node.header.block_id =
            "000006d08aa94e7acbe657fc385a2260823a528702b4de57452dfda0587dc8e0".to_string();
